...
INSERT INTO trgt_tbl (ID, SEQVAL, REC_EFF_TS, REC_EXPIR_TS, BTCH_JOB_ID, CURR_REC_IND, TBL1_COL, TBL2_COL)
SELECT
  ID,
  SEQVAL,
  REC_EFF_TS,
  ...
  TBL2_COL
FROM ranked_records
WHERE row_num = 1 -- Insert only the latest records

-- Additional SQL for src_tbl, src_tbl1, and src_tbl2
SELECT
  t.ID,
  t.SEQVAL,
  t.REC_EFF_TS,
